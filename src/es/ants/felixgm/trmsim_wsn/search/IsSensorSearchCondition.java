 ...
 * a given sensor has a specific identifier</p>
 * @author <a href="http://ants.dif.um.es/~felixgm/en" target="_blank">F&eacute;lix G&oacute;mez M&aacute;rmol</a>, <a href="http://webs.um.es/gregorio" target="_blank">Gregorio Mart&iacute;nez P&eacute;rez</a>
 * @version 0.2
 * @since 0.2
 */
public class IsSensorSearchCondition implements ISearchCondition {
     ...
     */
    public IsSensorSearchCondition(int sensorId){
     ...
     * @return true if the given sensor has a specific identifier, false otherwise
     */
