...
/**
 * <p>This class models a Linguistic Term, which is an association between a
  termName and a membership function</p>
...
public class LinguisticTerm {
    ...
    public double membership(double input) {
        return membershipFunction.membership(input);
    }

    public double defuzzify() {
        return membershipFunction.defuzzify();
    }
    ...
    public MembershipFunction get_membershipFunction() {
        return membershipFunction;
    }

    public void setDefuzzifier(Defuzzifier defuzzifier) {
        membershipFunction.setDefuzzifier(defuzzifier);
    }
}