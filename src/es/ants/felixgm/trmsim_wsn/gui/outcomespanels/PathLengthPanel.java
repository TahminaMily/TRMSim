...
/**
 * <p>This class represents the generic panel used to plot the path length of
 * the solution found by every Trust and Reputation Model, leading to the most
 * trustworthy/reputable node in the network</p>
 * @author <a href="http://ants.dif.um.es/~felixgm/en" target="_blank">F&eacute;lix G&oacute;mez M&aacute;rmol</a>, <a href="http://webs.um.es/gregorio" target="_blank">Gregorio Mart&iacute;nez P&eacute;rez</a>
 * @version 0.4
 * @since 0.4
 */
public class PathLengthPanel extends OutcomesPanel {
    ...
    protected double maxPathLength = 1.0;

    /**
     * Class PathLengthPanel constructor
     * @param outcomes Outcomes to be plotted in this outcomes panel
     */
    public PathLengthPanel(Collection<Outcome> outcomes) {
        super(outcomes);
        initComponents();
    }
    ...
    protected void drawAxes(Graphics graphics) {
        ...
        graphics.drawString(String.valueOf(((int)((maxPathLength/5.0)*100))/100.0), 1, (int)(height*yAxisMargin*0.8)+5);
        graphics.drawString(String.valueOf(((int)(((maxPathLength*2.0)/5.0)*100))/100.0), 1, (int)(height*yAxisMargin*0.6)+5);
        graphics.drawString(String.valueOf(((int)(((maxPathLength*3.0)/5.0)*100))/100.0), 1, (int)(height*yAxisMargin*0.4)+5);
        graphics.drawString(String.valueOf(((int)(((maxPathLength*4.0)/5.0)*100))/100.0), 1, (int)(height*yAxisMargin*0.2)+5);
    ...
    protected void plotOutcomes(Collection<Outcome> outcomes, Graphics graphics) {
        ...
        for (Outcome outcome : outcomes) 
            if (maxPathLength < ((BasicOutcome)outcome).get_avgPathLength())
                maxPathLength = (int) Math.ceil(((BasicOutcome)outcome).get_avgPathLength());

        if (maxPathLength % 2 == 1)
            maxPathLength++;
        ...
        if (outcomes.size() <= windowsSize) {
            ...
            for (Outcome outcome : outcomes) {
                ...
                value = ((BasicOutcome)outcome).get_avgPathLength();

                next_y = (int)((1.0-(value/maxPathLength))*(height*yAxisMargin));
                graphics.setColor(currentValueColor);
                graphics.drawLine(curr_x,curr_y,curr_x+xIncr,next_y);

                avg += value;
                avg_next_y = (int)((1.0-((avg/count)/maxPathLength))*(height*yAxisMargin));
                graphics.setColor(averageValueColor);
            ...
            for (Outcome outcome : outcomes) {
                ...
                if (count <= (outcomes.size()-windowsSize)) {
                    curr_y = (int)((1.0-(value/maxPathLength))*(height*yAxisMargin));
                    avg_y = (int)((1.0-((avg/count)/maxPathLength))*height*yAxisMargin);
                    continue;
                }
        ...
        if (lastOutcome != null) {
            value = ((int)(((BasicOutcome)lastOutcome).get_avgPathLength()*100))/100.0;
            graphics.drawString("Current: "+value, (int)(1.5*width*xAxisMargin*(2-xAxisMargin))+5,(int)(0.5*height*(yAxisMargin+1))+5);
            graphics.drawString("Average: "+(int)((avg/count)*100)/100.0, (int)(width*0.5*(1.0-xAxisMargin))+5, (int)(0.5*height*(yAxisMargin+1))+5);
        } else {
            graphics.drawString("Current: ", (int)(1.5*width*xAxisMargin*(2-xAxisMargin))+5,(int)(0.5*height*(yAxisMargin+1))+5);
            graphics.drawString("Average: ", (int)(width*0.5*(1.0-xAxisMargin))+5, (int)(0.5*height*(yAxisMargin+1))+5);
        }
